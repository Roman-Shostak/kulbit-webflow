...
_Останнє оновлення цього файлу: 21 травня 2026 — Кроки 2, 3, 4 завершено. Крок 2: розмітка секцій (варіант A, ADR-007). Крок 3: ПИВОТ — ScrollSmoother прибрано, жорсткий fullpage на Observer + transform з анти-інерцією (ADR-008), модулі `01-03`. Крок 4: кнопки-переходи (`04-navigation.js`, делегування + резолв номер/імʼя). Наступний — Крок 5 (перша покрокова анімація на одній секції)._
