...
Підставляєш короткий хеш свіжого коміту (напр. `@1977148`), тестуєш одразу, потім повертаєш `@main` коли кеш розсмокчеться. **Останній запушений коміт: `1977148`** (hero-кнопка: ховер/фокус + кольори). _Перед ним: `05adb4e` (matchMedia + таймінг паузи відео)._
...
**Стан деплою:** усе **ЗАПУШЕНО на `origin/main`, останній коміт `1977148`** (hero-кнопка: ховер/фокус-лінія + зміна кольорів). Бандл ~52.6 KB.
